var TWBot = {
        ...
        showAttack: function () {
            ...
            for (unitType in this.unitPerAttack) {
                if (TWBot.attacks.unitPerAttack[unitType] > 0) {
                    ...
                    $('<img />').attr('src', 'https://raw.github.com/donghyeon/tw_rep/master/images/unit_' + a + '.png').attr('title', d).attr('alt', b).appendTo(this.attackUnits).click(function (e) {
    ...
    htmlsnippets: {
        ...
        panel: '<div id="panel"><span id="tack">TWBot <img src="https://raw.github.com/donghyeon/tw_rep/master/images/Pushpin_B.png" class="on" height="15" /><img src="https://raw.github.com/donghyeon/tw_rep/master/images/Pushpin_A.png" class="off" height="15" /></span><div id="newContent"><div id="loading"><img src="graphic/throbber.gif" title="Loading something please wait..." alt="Loading something please wait..." /></div><ul id="messages"><li>Initialized layout</li><li>Loading available troops</li></ul><div id="attackListWrapper"><table id="attackList"></table></div><div id="rAttackListWrapper"><table id="rAttackList"></table></div><h3 id="attackName"></h3><table id="unitTable"><tbody><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td id="attackUnits" class="nowrap"><img src="https://raw.github.com/donghyeon/tw_rep/master/images/attack_small.png" title="Attacked villages" alt="Attacked villages" class="" /><input id="attackedVillages" name="attackedVillages" type="text" style="width: 40px" tabindex="10" value="" class="unitsInput" disabled="disabled" /><i id="amount_of_attackedVillages">fetching...</i>&nbsp;</td></tr></tbody></table></td></tr><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><img src=""https://raw.github.com/donghyeon/tw_rep/master/images/attack_small.png" title="Attacked villages" alt="Attacked villages" class="" /><input id="attackedVillages" name="attackedVillages" type="text" style="width: 40px" tabindex="10" value="" class="unitsInput" disabled="disabled" /><i id="amount_of_attackedVillages">fetching...</i>&nbsp;</td></tr></tbody></table></td></tr></tbody></table><div id="buttons"><button id="attackButton">Attack</button><button id="sAttackButton">Stop attacking</button><label for="continuousAttack">Don\'t stop</label> <input type="checkbox" id="continuousAttack" title="if checked the pause at the end of a cycle is omitted" checked="checked"/><label for="botting" title="This may get you banned! but so may using the rest of the script..">BotMode</label> <input type="checkbox" id="botting" title="if checked the page will be prevented from reloading and upon arrival of enough troops the attacks continue automagically" checked="checked"/><label for="ignorePlayers">Users?</label> <input type="checkbox" id="ignorePlayers" title="if checked no user village will be attacked, only Barbs get to fear you" checked="checked"/><button id="cAttackButton">New Attack</button><button id="resetAttack" title="Reset attackcounter to the first village">reset</button><button id="showSplash">Help!</button><label for="autoPilot" title="NOT WORKING YET!!! This will try to attack the villages determined by our glorious leaders.">AutoPilot</label> <input type="checkbox" id="autoPilot" title="if checked the swarm takes over the control for some attacks!"/></div></div></div>',
        popup: '<div id="popup_container"> <div id="popup_box_bg"></div> <div id="fader" onclick="$(\'#fader,#popup_container\').hide();"></div> <div class="show" style="width: 700px; margin-left: -350px" id="popup_box"> <div class="popup_box_content"> <a id="popup_box_close" onclick="$(\'#popup_container\').hide(); return false;" href="#"></a> <div style="background: no-repeat url(\'/graphic/paladin_new.png\');"> <h3 style="margin: 0 3px 5px 120px;">Create new attack plan</h3> <table style="margin-bottom: 5px;" align="right"> <tbody> <tr> <td class="quest-summary" width="200"> <h5>Give it a name:</h5> <p style="padding: 5px"> <input type="text" id="template_name" /> </p> </td> <td class="quest-summary" width="310"> Enter here the new coordinates for this attack <p style="padding: 5px"> <input type="text" id="template_coords" /> </p> <br> Determine resending period <p style="padding: 5px"> <input type="text" style="width: 40px" id="resending_period" value="100" /> </p> <br> Determine your own alarm url <p style="padding: 5px"> <input type="text" id="alarm_url" value="http://xczsonn.blog.me/195951861" /> </p> </td> </tr> </tbody> </table> <div class="quest-goal"> <table id="unitTableTemplate"> <tbody> <tr> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_spear.png" title="Spear fighter" alt="Spear fighter" class="" /> <input id="template_unit_input_spear" name="spear" type="text" style="width: 40px" tabindex="1" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_sword.png" title="Swordsman" alt="Swordsman" class="" /> <input id="template_unit_input_sword" name="sword" type="text" style="width: 40px" tabindex="2" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_axe.png" title="Axeman" alt="Axeman" class="" /> <input id="template_unit_input_axe" name="axe" type="text" style="width: 40px" tabindex="3" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_archer.png" title="Archer" alt="Archer" class="" /> <input id="template_unit_input_archer" name="archer" type="text" style="width:40px" tabindex="4" value="" class="unitsInput" /> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_spy.png" title="Scout" alt="Scout" class="" /> <input id="template_unit_input_spy" name="spy" type="text" style="width: 40px" tabindex="5" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_light.png" title="Light cavalry" alt="Light cavalry" class="" /> <input id="template_unit_input_light" name="light" type="text" style="width: 40px" tabindex="6" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_marcher.png" title="Marcher" alt="Marcher" class="" /> <input id="template_unit_input_marcher" name="marcher" type="text" style="width:40px" tabindex="7" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_heavy.png" title="Heavy cavalry" alt="Heavy cavalry" class="" /> <input id="template_unit_input_heavy" name="heavy" type="text" style="width: 40px" tabindex="8" value="" class="unitsInput" /> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_ram.png" title="Ram" alt="Ram" class="" /> <input id="template_unit_input_ram" name="ram" type="text" style="width: 40px" tabindex="9" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_catapult.png" title="Catapult" alt="Catapult" class="" /> <input id="template_unit_input_catapult" name="catapult" type="text" style="width: 40px" tabindex="10" value="" class="unitsInput" /> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_knight.png" title="Paladin" alt="Paladin" class="" /> <input id="template_unit_input_knight" name="knight" type="text" style="width: 40px" tabindex="11" value="" class="unitsInput" /> </td> </tr> <tr> <td class="nowrap"> <img src="https://raw.github.com/donghyeon/tw_rep/master/images/unit_snob.png" title="Nobleman" alt="Nobleman" class="" /> <input id="template_unit_input_snob" name="snob" type="text" style="width: 40px" tabindex="12" value="" class="unitsInput" /> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </div> </div> <div style="padding: 10px;" align="center"> <a class="btn" id="saveTemplate" onclick="$(\'#fader,#popup_container\').hide(); return false;">Continue</a> <input type="hidden" id="template_attackId" value="" /> <input type="hidden" id="template_position" value="" /> </div> </div> </div></div>'
    }
};
TWBot.init();